...
def upgrade():
    ...
    op.alter_column(
        "submissions", "form_id", existing_type=sa.INTEGER(), nullable=False
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "users", sa.Column("upgraded", sa.BOOLEAN(), autoincrement=False, nullable=True)
    )
    ...
    op.alter_column("submissions", "form_id", existing_type=sa.INTEGER(), nullable=True)
